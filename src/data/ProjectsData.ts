...
export const projectsData: Project[] = [
  {
    ...
    githubUrl: "https://github.com/putrarizky/portofy.git",
    ...
    gallery: [
      { id: 1, url: "/images/projects/portofy/home-page.png", caption: "Home Page" },
      { id: 2, url: "/images/projects/portofy/login-page.png", caption: "Login Page" },
      { id: 3, url: "/images/projects/portofy/register-page.png", caption: "Register Page" },
      { id: 4, url: "/images/projects/portofy/dashboard.png", caption: "Dashboard" },
      { id: 5, url: "/images/projects/portofy/about-page.png", caption: "About Page" },
      { id: 6, url: "/images/projects/portofy/education-page.png", caption: "Education Page" },
      { id: 7, url: "/images/projects/portofy/experience-page.png", caption: "Experience Page" },
      { id: 8, url: "/images/projects/portofy/architecture.png", caption: "Architecture" },
    ],
    features: [
      {
  ...
  },
  {
    ...
    gallery: [
      { id: 1, url: "/images/projects/dekatku/1.png", caption: "User View" },
      { id: 2, url: "/images/projects/dekatku/2.png", caption: "Chat Bot/AI View" },
      { id: 3, url: "/images/projects/dekatku/3.png", caption: "Dashboard Admin" },
      { id: 4, url: "/images/projects/dekatku/4.png", caption: "Dashboard Product Admin" },
      { id: 5, url: "/images/projects/dekatku/5.png", caption: "Dashboard Super Admin" },
      { id: 6, url: "/images/projects/dekatku/6.png", caption: "Search Toko Terdekat" },
    ],
    features: [
      {
  ...
  },
  {
    ...
    tags: ["Golang", "Clean Architecture", "REST API", "MySQL", "Docker", "Microservices"],
    ...
    gallery: [
      { id: 1, url: "/images/projects/tratech/1.png", caption: "Home Page" },
      { id: 2, url: "/images/projects/tratech/2.png", caption: "Certificate Detail Page" },
      { id: 3, url: "/images/projects/tratech/3.png", caption: "About Page" },
      { id: 4, url: "/images/projects/tratech/4.png", caption: "Certifate Page" },
      { id: 5, url: "/images/projects/tratech/5.png", caption: "Contact Page" },
      { id: 6, url: "/images/projects/tratech/6.png", caption: "Project Detail Page" },
    ],
    features: [
      {
  ...
  },
  {
    ...
    gallery: [
      { id: 1, url: "/images/projects/golang-api-ecommerce/1.png", caption: "docker-compose up --build" },
      { id: 2, url: "/images/projects/golang-api-ecommerce/2.png", caption: "Docker Container Status" },
      { id: 3, url: "/images/projects/golang-api-ecommerce/3.png", caption: "Login Endpoint Test" },
      { id: 4, url: "/images/projects/golang-api-ecommerce/4.png", caption: "Products Endpoint Test" },
      { id: 5, url: "/images/projects/golang-api-ecommerce/5.png", caption: "Transaction Endpoint Test" },
      { id: 6, url: "/images/projects/golang-api-ecommerce/6.png", caption: "Project Structure (Tree View)" },
    ],
    features: [
      {
  ...
  },
  {
    ...
    techStack: [
      ...
      { name: "Moota Gateway", Icon: MdPayment as unknown as Project["techStack"][0]["Icon"], color: "#10B981" },
    ],
    gallery: [
      { id: 1, url: "/images/projects/ecommerce-laravel-filament/1.png", caption: "Home Page" },
      { id: 2, url: "/images/projects/ecommerce-laravel-filament/2.png", caption: "Feature Page" },
      { id: 3, url: "/images/projects/ecommerce-laravel-filament/3.png", caption: "Product Page" },
      { id: 4, url: "/images/projects/ecommerce-laravel-filament/4.png", caption: "Cart Page" },
      { id: 5, url: "/images/projects/ecommerce-laravel-filament/5.png", caption: "Checkout Page" },
      { id: 6, url: "/images/projects/ecommerce-laravel-filament/6.png", caption: "Transaction" },
      { id: 7, url: "/images/projects/ecommerce-laravel-filament/7.png", caption: "Transaction" },
      { id: 8, url: "/images/projects/ecommerce-laravel-filament/8.png", caption: "Admin panel" },
      { id: 9, url: "/images/projects/ecommerce-laravel-filament/9.png", caption: "Admin panel" },
    ],
    features: [
      {
